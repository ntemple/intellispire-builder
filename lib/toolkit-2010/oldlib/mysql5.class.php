 ...
 * @version    SVN: $Id: mysql5.class.php 21 2013-03-15 19:35:01Z ntemple $
 * @since      File available since Release 0.1
 */
require_once('linkedexception.class.php');
require_once('mysql.class.php'); // For functions

class MySQLException extends LinkedException { }
