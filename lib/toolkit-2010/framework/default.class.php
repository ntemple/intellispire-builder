 ...
 * @version    SVN: $Id: default.class.php 21 2013-03-15 19:35:01Z ntemple $
...
class basicClass extends Object {
  ...
  function doView(&$request, &$response) {
     sabrayla_trace("+basicClass doView");
     $this->_template = $request->_original_page;
     sabrayla_log($request);

     $response->_template = $this->_template;
     sabrayla_log($response);
...
/*
     if (AUTOBUILD > 0) {
        $this->_buildtemplate('doview.tpl.html');
     }
*/
  }
