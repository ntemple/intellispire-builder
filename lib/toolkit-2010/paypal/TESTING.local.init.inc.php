<?php
  ...
  //  THIS IS TESTING
     ...
     define('PDC_ROOTPATH', './');
     define('PDC_SITENAME', 'testing.pdc.intelliforge.org');
     define('PDC_WEBMASTEREMAIL', 'admin@pdc.intelliforge.org');

     define('PDC_LOG_DIR', '/home/pdcforge/logs');
     ...
     define('PDC_PP_NOTIFY_URL', 'http://testing.pdc.intelliforge.org/paypal.ipn.php'); // {notify_url}
     ...
     define('PDC_SM_NOTIFY_URL', 'http://testing.pdc.intelliforge.org/stormpay.ipn.php');    // {norify_url}
