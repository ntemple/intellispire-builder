<?php
/*
Plugin Name: Newsletter {name} Newsletter Signup
Plugin URI: http://www.intellispire.com/
Description: Connect WordPress Registration to {name}
Version:  {version}
...
function newsletter_/*{lcname}*/() {
    return /*{UNIQUEID}*//*{cname}*/Newsletter::instance();
}
newsletter_/*{lcname}*/();

class /*{UNIQUEID}*//*{cname}*/Newsletter {
    ...
    // Classes
    var $optionsPage;  // /*{UNIQUEID}*//*{cname}*/NewsletterSettingsPage
    var $updater;      // /*{UNIQUEID}*//*{cname}*/NewsletterProEDD_SL_Plugin_Updater
    var $coreclass;
    ...
    private function setup_admin() {
        ...
        $this->optionsPage = new /*{UNIQUEID}*//*{cname}*/NewsletterSettingsPage($this->item_name, $this->prefix, $this->params);
    }
    ...
    private function update() {
        ...
        $this->updater = new /*{UNIQUEID}*//*{cname}*/NewsletterProEDD_SL_Plugin_Updater( $this->update_server, __FILE__, array(
